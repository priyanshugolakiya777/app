...
import 'package:loan_app/screens/typesofloan/afterdocument.dart';

class document extends StatefulWidget {
  String typeofloan;
  document(this.typeofloan, {super.key});

  @override
  State<document> createState() => _personalloanState();
}

class _personalloanState extends State<document> {
  @override
  void initState() {
    // ignore: todo
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(child: Text("${widget.typeofloan} Document")),
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Expanded(
                    // ignore: prefer_const_constructors
                    child: Text.rich(TextSpan(text: "${setlanguage[12]}")),
                  )
                ],
              ),
            ),
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Expanded(
                    // ignore: prefer_const_constructors
                    child: Text.rich(TextSpan(text: "${setlanguage[13]}")),
                  )
                ],
              ),
            )
  ...
  void forlanguage() {
    if (colorcnt == 0) {
      setState(() {
        setlanguage = [];
        setlanguage.addAll(Model.documentenglish);
      });
      print("=====$setlanguage");
    } else if (colorcnt == 1) {
      setState(() {
        setlanguage = [];
        setlanguage.addAll(Model.documenthindi);
      });
      print("====22=$setlanguage");
    } else if (colorcnt == 2) {
      setState(() {
        setlanguage = [];
        setlanguage.addAll(Model.documentgujrati);
      });
