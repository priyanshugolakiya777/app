...
import 'package:loan_app/screens/questionsscreen/questiontwo.dart';

class questionone extends StatefulWidget {
  const questionone({super.key});

  @override
  State<questionone> createState() => _fifthscreenState();
}

class _fifthscreenState extends State<questionone> {
  String? ss;
  @override
  void initState() {
    // ignore: todo
  ...
  void forlanguagee() {
    if (len == true) {
       ss = Model.questionsenglish[0];
    } else {
       ss = Model.questionshindi[0];
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Center(child: Text("Qua. - 01/10")),
