...
import 'package:loan_app/screens/questionsscreen/questionseven.dart';

class questionsix extends StatefulWidget {
  const questionsix({super.key});

  @override
  State<questionsix> createState() => _fifthscreenState();
}

class _fifthscreenState extends State<questionsix> {
  String? ss;
  @override
  void initState() {
    // ignore: todo
  ...
  void forlanguagee() {
    if (len == true) {
      ss = Model.questionsenglish[5];
    } else {
      ss = Model.questionshindi[5];
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Center(child: Text("Qua. -06/10")),
