...
import 'package:loan_app/screens/questionsscreen/questionthree.dart';

class questiontwo extends StatefulWidget {
  const questiontwo({super.key});

  @override
  State<questiontwo> createState() => _fifthscreenState();
}

class _fifthscreenState extends State<questiontwo> {
  ...
  void forlanguagee() {
    if (len == true) {
       ss = Model.questionsenglish[1];
    } else {
       ss = Model.questionshindi[1];
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Center(child: Text("Qua. -02/10")),
