...
import 'package:loan_app/screens/questionsscreen/questionseix.dart';

class questionfive extends StatefulWidget {
  const questionfive({super.key});

  @override
  State<questionfive> createState() => _fifthscreenState();
}

class _fifthscreenState extends State<questionfive> {
  String? ss;
  @override
  void initState() {
    // ignore: todo
  ...
  void forlanguagee() {
    if (len == true) {
      ss = Model.questionsenglish[4];
    } else {
      ss = Model.questionshindi[4];
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Center(child: Text("Qua. -05/10")),
