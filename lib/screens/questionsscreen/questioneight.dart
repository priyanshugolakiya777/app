...
import 'package:loan_app/screens/questionsscreen/questionnine.dart';

class questioneight extends StatefulWidget {
  const questioneight({super.key});

  @override
  State<questioneight> createState() => _fifthscreenState();
}

class _fifthscreenState extends State<questioneight> {
  String? ss;
  @override
  void initState() {
    // ignore: todo
  ...
  void forlanguagee() {
    if (len == true) {
      ss = Model.questionsenglish[7];
    } else {
      ss = Model.questionshindi[7];
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Center(child: Text("Qua. -08/10")),
